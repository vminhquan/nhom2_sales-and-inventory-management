...
{
    /// <summary>
    /// REST API Controller cho Order
    /// Đây là tầng Presentation - tiếp nhận request từ client
    /// 
    /// Flow:
    /// Client → OrderApi (Controller) → OrderService → OrderRepository → Database
    /// Database → OrderRepository → OrderService → OrderApi → Client
    /// </summary>
    [ApiController]
    ...
    public class OrderController : ControllerBase
    {
        ...
        /// <summary>
        /// PUT: api/order/{id}
        /// Cập nhật đơn hàng (thay đổi trạng thái)
        /// Body:
        /// {
        ///   "id": 1,
        ///   "status": "Processing"
